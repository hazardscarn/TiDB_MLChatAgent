...
def clean_sql(sql):
    ...
    sql = sql.replace("\\\\", "")
    # Remove 'n' characters left after newline replacements
    sql = sql.replace("\\n", " ")
...
3. **Data Analyst**:\n
    ...
    b. What is the average predicted churn rate across occupation for customers with revenue_per_minute more than 0.5?\n
...
def walkthrough():
    ...
    """
    response = """
    Hello! I'. TiDB.ML 🤖 your friendly AI assistant to effortlessly interact with the powerful machine learning models.
